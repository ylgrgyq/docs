...
我们目前提供 REST API 允许向一个已有对话发送消息。**注意**，由于这个接口的管理性质，当你通过这个接口发送消息时，我们不会检查 `from_peer` 是否有权限给这个对话发送消息，而是统统放行，请谨慎使用这个接口。
...
错误信息包含 `code` 与 `reason` 字段，其中 `code` 值遵守[实时通信错误码定义](https://leancloud.cn/docs/realtime_v2.html#%E6%9C%8D%E5%8A%A1%E5%99%A8%E7%AB%AF%E9%94%99%E8%AF%AF%E7%A0%81%E8%AF%B4%E6%98%8E)。
