...
如果你在应用中使用了我们内部定义的[富媒体消息格式](./realtime_v2.html#%E6%B6%88%E6%81%AF_Message_)，在发送消息时 `message` 字段需要遵守一定的格式要求，下文[富媒体消息格式说明](.//realtime_rest_api.html#富媒体消息格式说明)中将详细说明。
