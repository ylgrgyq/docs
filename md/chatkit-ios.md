...
-------------|-------------|-------------|-------------
![enter image description here](images/chatkit-ios/chatkit-screenshot-01.png)|![enter image description here](images/chatkit-ios/chatkit-screenshot-02.png)  | ![enter image description here](images/chatkit-ios/chatkit-screenshot-03.png) 

 地理位置消息| 失败消息本地缓存，可重发 |上传图片，进度条提示 
 -------------|-------------|-------------
![enter image description here](images/chatkit-ios/chatkit-screenshot-04.png) | ![enter image description here](images/chatkit-ios/chatkit-screenshot-05.png)| ![enter image description here](images/chatkit-ios/chatkit-screenshot-06.png)
