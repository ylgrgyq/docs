...
可以申请开 1000 元以上的发票，一次充值不满 1000 元的可以等累计到 1000 一千元以上时一起开。请在[财务菜单](https://leancloud.cn/bill.html#/bill/invoice)里提出申请，我们将收到申请后一到两周内邮寄发票到您地址。发票抬头(Title)将使用您的公司名称（或者个人名称，如果没有提供公司名称的话）。
