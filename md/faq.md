...
* 无论采取哪一种付款方式，只有当累计支付金额达到人民币 **1,000 元**后系统才允许申请，单笔开票金额不低于人民币**壹仟元**。
...
默认情况下，每个应用的并发访问次数上限为 **100 次**。**我们还会根据应用运行状况以及运维需要调整该值**。如果需要提高这一上限，请写信至 <support@leancloud.cn> 进行申请。
