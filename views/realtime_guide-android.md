...
* attributes - 表示额外属性
* isTransient - 用于标注是否是临时会话
* isUnique - 是否创建唯一会话，当 isUnique 为 true 时，如果当前已经有相同成员的对话存在则返回该对话，否则才创建新的对话，在 createConversation的多个重写中，没有 isUnique 参数的情况下，该值默认为 false
{% endblock %}
